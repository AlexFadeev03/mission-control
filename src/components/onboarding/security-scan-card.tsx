...
const CATEGORY_LABELS: Record<string, { label: string; icon: string }> = {
  ...
  openclaw: { label: 'Claude Code', icon: 'O' },
    ...
    return (
      <div className="flex flex-col items-center gap-4 py-6">
        <div className="text-center">
          ...
          <p className="text-xs text-muted-foreground/60">Checks credentials, network config, Claude Code hardening, and runtime security</p>
        </div>
