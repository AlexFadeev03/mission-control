    ...
    up: (db) => {
      db.exec(`
        CREATE TABLE IF NOT EXISTS tenants (
          ...
          status TEXT NOT NULL DEFAULT 'pending',
          claude_code_home TEXT NOT NULL,
    ...
    up: (db) => {
      ...
      if (tenantCount > 0) {
        ...
        const insert = db.prepare(`
          INSERT INTO tenants (slug, display_name, linux_user, plan_tier, status, claude_code_home, workspace_root, config, created_by, owner_gateway)
