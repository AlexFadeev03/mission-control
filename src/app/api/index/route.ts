...
const endpoints: Endpoint[] = [
  ...
  { path: '/api/claude-code/version', methods: ['GET'], description: 'Installed Claude Code version and latest release metadata', tag: 'System', auth: 'public' },
  { path: '/api/claude-code/update', methods: ['POST'], description: 'Update Claude Code to the latest stable release', tag: 'System', auth: 'admin' },
  { path: '/api/claude-code/doctor', methods: ['GET', 'POST'], description: 'Inspect and fix Claude Code configuration drift', tag: 'System', auth: 'admin' },
